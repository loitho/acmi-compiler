...
//			_simTapeEntities[i].objBase = new SimBaseClass(EntityType(i));
//			GetEntityPosition ( i,
...
//		}
//		F4Assert(_simTapeEntities[i].objBase != NULL);
//
//		// set the matrix
...
//		{
//			_simTapeEntities[i].objTrail = new DrawableTrail(TRAIL_AIM120);
...
//			//_simTapeEntities[i].wlTrail = new DrawableTrail(TRAIL_TRACER1);
//			//_simTapeEntities[i].wrTrail = new DrawableTrail(TRAIL_TRACER2);
//																
//		}
//
//	}
